...
scoreboard players set #seeker_skill_interval_time game_control 1800
scoreboard players set #seeker_compass_range game_control 10
scoreboard players set #seeker_compass_range_increment game_control 3
data modify storage hide_and_seek:game_control initial_value merge value {seeker_wating_time:900,seek_time:12000,hider_cooling_time:200,respawn_time:600,seeker_skill_interval_time:1800}
data modify storage hide_and_seek:game_control initial_value merge value {seeker_num:1,hider_reward_point:5,seeker_compass_range:10,seeker_compass_range_increment:3}
