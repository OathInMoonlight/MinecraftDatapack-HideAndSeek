...
bossbar set hide_and_seek:seeker_wating_time_bar name {"text":"${seeker} ","color":"blue","extra":[{"text":"${seeker_come_in_seconds_1} ","color":"white"},{"score":{"name":"#seeker_wating_time_counter_seconds","objective":"game_control"},"color":"yellow"},{"text":" ${seeker_come_in_seconds_2}","color":"white"}]}
