...
execute as @a[team=hider,tag=showing_display_block] at @e[type=minecraft:interaction,tag=showing_display_block] run tp @a[team=hider,tag=showing_display_block] ~ ~ ~
